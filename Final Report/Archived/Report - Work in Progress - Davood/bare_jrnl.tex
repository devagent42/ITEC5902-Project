...
\bibitem{shen2021accurate} Shen, Meng and Zhang, Jinpeng and Zhu, Liehuang and Xu, Ke and Du, Xiaojiang, Accurate decentralized application identification via encrypted traffic analysis using graph neural networks, IEEE Transactions on Information Forensics and Security, 2021
